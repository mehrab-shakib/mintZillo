...
const Home = ({ home, provider,account,  escrow, togglePop }) => {
    ...
    // keep track on each user activity 
    ...
    const buyHandler = async () => {
      if (account !== buyer) {
        alert("This action is not allowed for this account.");
        return;
    }
    ...
    const sellHandler = async () => {
        ...
        // Seller finalize...
        transaction = await escrow.connect(signer).finalizeDeal(home.id)
        await transaction.wait()
